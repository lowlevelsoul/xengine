...
#endif
/* Tokens.  */
#define KW_MATERIAL 258
#define KW_TEXALBEDO 259
#define KW_TEXAMR 260
#define KW_TEXGLOW 261
#define KW_END 262
#define LITERAL_STRING 263
#define LITERAL_INT 264
#define LITERAL_FLOAT 265
...
{
      17,     0,    -1,    -1,     3,    18,    13,    19,    14,    -1,
      -1,    20,    -1,    21,    -1,    20,    21,    -1,    22,    -1,
      23,    -1,    24,    -1,     4,    15,    25,    -1,     5,    15,
      25,    -1,     6,    15,    25,    -1,     8,    -1
};
...
{
  "$end", "error", "$undefined", "KW_MATERIAL", "KW_TEXALBEDO",
  "KW_TEXAMR", "KW_TEXGLOW", "KW_END", "LITERAL_STRING", "LITERAL_INT",
  "LITERAL_FLOAT", "IDENTIFIER", "TOKEN_ERROR", "'{'", "'}'", "'='",
  "$accept", "material", "@1", "mat_contents", "mat_item_list", "mat_item",
  "tex_albedo", "tex_amr", "tex_glow", "lit_string", 0
};
#endif
...
{
       2,   -14,     6,    -6,   -14,    -4,    -7,    -5,    -3,    -1,
      -4,   -14,   -14,   -14,   -14,     1,     1,     1,   -14,   -14,
     -14,   -14,   -14,   -14
};
...
{
       6,     7,     8,    22,    23,     1,     4,     5,    15,    20,
      16,     0,    17,    18,    19
};

static const yytype_int8 yycheck[] =
{
       4,     5,     6,    16,    17,     3,     0,    13,    15,     8,
      15,    -1,    15,    14,    10
};
...
{
       0,     3,    17,    18,     0,    13,     4,     5,     6,    19,
      20,    21,    22,    23,    24,    15,    15,    15,    14,    21,
       8,    25,    25,    25
};
...
yyreduce:
  ...
  case 11:
    ...
    {
        MaterialResource_SetAlbedoTexture( &(yyvsp[(3) - (3)]) );
    ;}
    break;
  ...
  case 13:
    ...
    {
         MaterialResource_SetGlowTexture( &(yyvsp[(3) - (3)]) );
    ;}
    break;
